...
namespace DirectoryServer
{
    class User
    {
        ...
        public List<User> IntialiseUserBase()
        {
            User[] user = new User[5];
            List<User> users = new List<User>();
            user[0].UserName = "bob";
            user[0].Password = "imbob";
            user[1].UserName = "pattrick";
            user[1].Password = "impattrick";
            user[2].UserName = "chris";
            user[2].Password = "imchris";
            users.Add(user[0]);
            users.Add(user[1]);
            users.Add(user[2]);
            return users;
        ...
        {
            // Make sure no users already in list
